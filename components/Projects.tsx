...
import { ExternalLink, ArrowUpRight, Play, X, Maximize2 } from 'lucide-react';

// Extracted and Memoized Project Card Component
const ProjectCard = memo(({ project, index, onSelect }: { project: typeof PROJECTS[0], index: number, onSelect: (url: string) => void }) => {
        ...
        >
            ...
            <div className="lg:col-span-5 order-2 lg:order-1">
                <div className="flex items-center gap-3 mb-4 text-cyberCyan font-space text-xs tracking-widest">
                    <span>0{index + 1}</span>
                    <span className="w-10 h-[1px] bg-cyberCyan/30"></span>
                ...
                <div className="flex flex-wrap gap-3 mb-8">
                    {project.tech.map((tech) => (
                        <span key={tech} className="px-3 py-1 text-xs font-space border border-white/10 rounded-full text-gray-400">
                            {tech}
                        </span>
                    ))}
                </div>
    ...
    LIVE DEMO <ArrowUpRight size={16} />
            ...
            <div className="lg:col-span-7 order-1 lg:order-2 relative">
                ...
                >
                     ...
                     {/* Grid Overlay (Fades out on hover) */}
                     <div 
